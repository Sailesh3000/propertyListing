    ...
    return (
      <div className="page-container">
        <div className="text-center py-12">
          <h3 className="text-lg font-medium text-gray-900">Please login to edit property listings</h3>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-container">
      <div className="card max-w-3xl mx-auto">
        <div className="p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Edit Property Listing</h2>
          {error && (
